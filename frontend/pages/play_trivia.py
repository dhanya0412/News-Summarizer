...
st.markdown("<p style='text-align: center; color: #666; font-size: 1.1em; margin-bottom: 30px;'>Choose a topic and test your knowledge with MCQ/fill in the blank questions.</p>", unsafe_allow_html=True)
...
if st.session_state.get("play_trivia_start"):
    ...
    #buttton to play again (reloads with same topic)
    st.markdown("---")
